...
from .dinov2_layers import Mlp, PatchEmbed, SwiGLUFFNFused, MemEffAttention, Attention, NestedTensorBlock as Block
...
class DinoVisionTransformer(nn.Module):
    ...
    def _get_intermediate_layers_not_chunked(self, x, n=1, attn_bias=None):
    ...
    def get_intermediate_layers(
        ...
        if self.chunked_blocks:
            ...
            outputs = self._get_intermediate_layers_not_chunked(x, n, attn_bias)
        if norm:
        ...
        if self.include_cls_token:
            ...
            class_tokens = [out[:, 0] for out in outputs] #not real cls tokens
